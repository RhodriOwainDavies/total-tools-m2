...
define([
    ...
    return Component.extend({
        ...
        selectAddress: function () {
            ...
            /* Use Ajax call to update additional shipping message when switching shipping address */
            var shippingAddress = this.address();
            var xhrAdditional = $.ajax({
                url: $('#baseurl').val() + 'temando/checkout/getadditionalmessage',
